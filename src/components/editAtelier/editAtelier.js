...
handleUploadImage(ev) {
  ...
  fetch('https://back-projet.herokuapp.com/api/users/putArticle/'+ this.props.match.params.id, {
    method: 'PUT',
    body: data,
  }).then((response) => {
    ...
    response.json().then((body) => {
      this.setState({ image: `https://back-projet.herokuapp.com/api/users/newArticle/${body.image}` });
